    ...
    <View className="flex-1 px-6">
      ...
      <View className="flex-1 justify-between mb-20">
        ...
        <View className="mb-8">
          ...
          />
          <View>
            <CustomEditProfileOption option="User name" rightComponentTitle="@bayuga" />
            <CustomEditProfileOption option="Name" rightComponentTitle="Betrand Bayuga" />
        ...
        <View className="items-center">
          <CustomReferenceButton
            ...
            customContainerClass={'bg-black border-2 px-0 py-2 w-52 border-white'}
