...
import MeetupAndJobButtons from '../../moments/components/MeetupAndJobButtons';
import PostCameraTabItem from '../../moments/components/PostCameraTabItem';
import { MomentsStackParamList } from '../../moments/MomentsStackNavigator';
import usePickImageAndUpload from 'hooks/usePickImage';
import { useSelfieActions } from '../../moments/hooks/useSelfieActions';
      ...
      <View className="flex-1  justify-between">
        ...
        <View
          ...
          <View>
            ...
            <View className="flex-row justify-between items-center mt-9 mb-20">
